<template>
    <div>
        ...
        <div class="intro">
            Fa molt de temps a una galaxia molt,<br> molt llunyana....
        </div>
        ...
        <div id="board">
            <div id="content">
                <p id="title">Episodi 8</p>
                <p id="subtitle">VUE AVANÇAT</p>
                <br>
                <p>Després de molt de temps aprenent Vue hem aconseguit fer una web de Star Wars.</p>
                <p>Hem fet servir vue-router i vuex per portar a terme aquesta tasca, esperem que sigui del vostre agrat.
                </p>
            </div>
        </div>
        <div class="ending">
            <img src="../assets/img/vader.png" width="200px" />
            <p>Què feu encara aquí? A la barra superior teniu les naus ("STARSHIPS"), vinga cap a allà!</p>
        </div>
    </div>
</template>
